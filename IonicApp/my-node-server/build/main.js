...
/* harmony import */ var _jersey__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./jersey */ "./src/jersey/index.js");
...
protectedApiRouter.use('/items', _jersey__WEBPACK_IMPORTED_MODULE_6__["router"].routes());
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./router */ "./src/jersey/router.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "router", function() { return _router__WEBPACK_IMPORTED_MODULE_0__["router"]; });
...
/* harmony import */ var koa_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! koa-router */ "koa-router");
/* harmony import */ var koa_router__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(koa_router__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./store */ "./src/jersey/store.js");
...
router.get('/jersey/:id', async ctx => {
  const userId = ctx.state.user._id;
  const jersey = await _store__WEBPACK_IMPORTED_MODULE_1__["default"].findOne({
    _id: ctx.params.id
  });
  const response = ctx.response;
...
const createJersey = async (ctx, jersey, response) => {
  ...
  try {
    ...
    response.body = await _store__WEBPACK_IMPORTED_MODULE_1__["default"].insert(jersey);
    response.status = 201; // created
...
/*!*****************************!*\
  !*** ./src/jersey/store.js ***!
  \*****************************/
/*! exports provided: JerseyStore, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JerseyStore", function() { return JerseyStore; });
/* harmony import */ var nedb_promise__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! nedb-promise */ "nedb-promise");
/* harmony import */ var nedb_promise__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(nedb_promise__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony default export */ __webpack_exports__["default"] = (new JerseyStore({
  filename: './db/jerseys.json',
  autoload: true
}));
...
module.exports = __webpack_require__(/*! C:\Users\Cata\Desktop\Anul 3\MA\ionica\my-node-server\src/index.js */"./src/index.js");
